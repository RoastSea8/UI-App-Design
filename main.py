...
class Login(MDScreen):
    ...
    class Teach4MeImg(MDRelativeLayout):
        pass
...
class Teach4Me(MDApp):
    ...
    def callback(self, screen):
        ...
        if self.root.current == self.screenList[-1]:
            ...
            profile_screen.ids['schoollabel'].font_size = self.root.width / 28
            profile_screen.ids['subjectlabel'].text = "Teaches " + subject
            profile_screen.ids['subjectlabel'].font_size = self.root.width / 28
            profile_screen.ids['extralabel'].text = "Inolved in " + extracurricular
            profile_screen.ids['extralabel'].font_size = self.root.width / 28
            if about_me == "":
                ...
                profile_screen.ids['aboutme'].font_size = self.root.width / 25
                profile_screen.ids['aboutme'].pos_hint = {"center_x": .55, "center_y": .52}
            profile_screen.ids['namelabel'].text = full_name
            profile_screen.ids['namelabel'].font_size = self.root.width / 25
            profile_screen.ids['email'].text = email
            profile_screen.ids['email'].font_size = self.root.width / 25
            profile_screen.ids['password'].text = password
            profile_screen.ids['password'].font_size = self.root.width / 25
